...
export function ContactForm({ formType, buttonText, buttonClassName }: ContactFormProps) {
	...
	const formDescription =
		formType === "early-access"
			? "Fill out the form below to collaborate in shaping Galaxia's enterprise solution."
			: "Fill out the form below to see Galaxia's enterprise capabilities in action."
