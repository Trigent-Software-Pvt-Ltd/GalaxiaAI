...
export const content: AgentPageContent = {
	...
	hero: {
		...
		paragraphs: [
			...
			"Galaxia's PR Reviewer uses advanced reasoning models and full repository context to find the issues that slip through—before they reach production.",
		],
		image: {
			url: hero.src,
			width: 800,
			height: 474,
			alt: "Example of a code review generated by Galaxia PR Reviewer",
		},
		crossAgentLink: {
	...
	howItWorks: {
		...
		steps: [
			...
			},
			{
				...
				description:
					"Every pull request gets detailed GitHub comments in minutes from a Galaxia agent highlighting issues and suggesting improvements.",
