...
export const GalaxiaSettingsSchema = providerSettingsSchema.merge(globalSettingsSchema)

export type GalaxiaSettings = GlobalSettings & ProviderSettings
...
export type GlobalState = Omit<GalaxiaSettings, Keys<SecretState>>

export const GLOBAL_STATE_KEYS = [...GLOBAL_SETTINGS_KEYS, ...PROVIDER_SETTINGS_KEYS].filter(
	(key: Keys<GalaxiaSettings>) => !isSecretStateKey(key),
) as Keys<GlobalState>[]
...
export const EVALS_SETTINGS: GalaxiaSettings = {
