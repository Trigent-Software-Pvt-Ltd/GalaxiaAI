...
/**
 * GalaxiaTelemetryEvent
 */

export const GalaxiaTelemetryEventSchema = z.discriminatedUnion("type", [
	z.object({
		type: z.enum([
...
export type GalaxiaTelemetryEvent = z.infer<typeof GalaxiaTelemetryEventSchema>
