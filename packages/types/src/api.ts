...
import type { GalaxiaEvents } from "./events.js"
...
export type GalaxiaAPIEvents = GalaxiaEvents

export interface GalaxiaAPI extends EventEmitter<GalaxiaAPIEvents> {
	/**
	 ...
	 * @returns The current configuration.
	 */
	getConfiguration(): GalaxiaSettings
	/**
	 * Sets the configuration for the current task.
	 * @param values An object containing key-value pairs to set.
	 */
	setConfiguration(values: GalaxiaSettings): Promise<void>
	/**
...
export interface GalaxiaIpcServer extends EventEmitter<IpcServerEvents> {
	listen(): void
