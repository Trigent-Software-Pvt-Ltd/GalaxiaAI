...
import type { JWTPayload, CloudUserInfo, AuthService, AuthServiceEvents, AuthState } from "@galaxia/types"
...
export class StaticTokenAuthService extends EventEmitter<AuthServiceEvents> implements AuthService {
	...
	public async getOrganizationMemberships(): Promise<import("@galaxia/types").CloudOrganizationMembership[]> {
		throw new Error("Authentication methods are disabled in StaticTokenAuthService")
	}
