 ...
 *
 * This class manages the state for the marketplace view in the Galaxia extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Galaxia extensions interface
...
import { MarketplaceItem } from "@galaxia/types"
